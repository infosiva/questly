...
export const metadata: Metadata = {
  title: "About | QuizBites",
  description: "About QuizBites — Live classroom quiz platform — teachers run engaging AI-generated quizzes in real time.",
...
export default function AboutPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      <h1 className="text-3xl font-bold mb-6">About QuizBites</h1>

      <section className="mb-8">
        <p className="text-base leading-7">Live classroom quiz platform — teachers run engaging AI-generated quizzes in real time.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-3">What We Offer</h2>
        <p>
          QuizBites is a free service built to make learning more accessible through the power of artificial intelligence.
      ...
      <section className="mb-8">
        ...
        <p>
          QuizBites is supported by advertising through Google AdSense. Ads help us keep the service
      ...
      <p className="mt-10 opacity-40 text-xs">© 2026 QuizBites. All rights reserved.</p>
    </main>
  );
}
