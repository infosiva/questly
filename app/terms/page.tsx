...
export const metadata: Metadata = {
  title: "Terms of Service | QuizBites",
  description: "Terms of service for QuizBites — your rights and responsibilities when using our service.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Acceptance of Terms">
        <p>
          By accessing or using QuizBites (https://quizbites.app), you agree to be bound by these Terms of Service.
          If you do not agree, please do not use the service.
        </p>
      </Section>

      <Section title="2. Description of Service">
        <p>Live classroom quiz platform — teachers run engaging AI-generated quizzes in real time.</p>
        <p className="mt-2">
      ...
      <Section title="5. Intellectual Property">
        <p>
          All original content, design and code on this service is owned by or licensed to QuizBites.
      ...
      <Section title="9. Limitation of Liability">
        <p>
          To the fullest extent permitted by law, QuizBites shall not be liable for any indirect,
