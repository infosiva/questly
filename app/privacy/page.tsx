...
export const metadata: Metadata = {
  title: "Privacy Policy | QuizBites",
  description: "Privacy policy for QuizBites — how we collect, use and protect your data.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Who We Are">
        <p>QuizBites (https://quizbites.app) is operated by an independent developer. Live classroom quiz platform — teachers run engaging AI-generated quizzes in real time.</p>
